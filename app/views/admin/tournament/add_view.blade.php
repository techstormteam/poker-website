...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="block-flat">
            ...
            <div class="content">
                <form class="form-horizontal group-border-dashed" action="<?= site_url("admin/tournament/add"); ?>" method="POST" style="border-radius: 0px;">
                    ...
                    <div class="form-group">
                        ...
                        <button class="col-sm-3 btn btn-default" onclick="location.href = '<?= site_url("admin/tournament/list_view"); ?>'">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
