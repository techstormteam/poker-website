...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="{{ $assets }}/uikit/css/uikit.gradient.css" rel="stylesheet" type="text/css" />
        <link href="{{ $assets }}/uikit/css/addons/uikit.addons.css" rel="stylesheet" type="text/css" />
        <link href="{{ $assets }}/uikit/css/addons/uikit.gradient.addons.css" rel="stylesheet" type="text/css" />
        @yield('style')
    ...
    <body>
        ...
        <script src="{{ $assets }}/uikit/js/jquery-1.11.1.min.js" type="text/javascript" ></script>
