...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="{{ $assets }}/bootstrap/js/addons/form-select.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/htmleditor.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/nestable.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/notify.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/pagination.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/search.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/sortable.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/sticky.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/timepicker.min.js"></script>
        <script src="{{ $assets }}/bootstrap/js/addons/upload.min.js"></script>
                ...
                <tr>
                    ...
                    <td><div id="menu">
                            <ul>
                                ...
                                <li><a href="{{ URL::to('home/register') }}">Register</a></li>
                                @else
                                <li><a href="{{ URL::to('home/logout') }}">Sign out</a></li>
                                @endif
                            </ul>
                        </div></td>
